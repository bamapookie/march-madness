import type { BracketSlotInput, CompetitionSettings, RankMap } from "@/types";
...
export function buildMinimal8TeamSlotsWithFirstFour(): BracketSlotInput[] {
  return [
    ...
    // First Four game slots
    {
      ...
      schoolId: null,
      nextSlotId: "E1",
      feedingSlotIds: ["LEAF_FF1a", "LEAF_FF1b"],
    },
    {
      id: "FF2",
      round: "FIRST_FOUR",
      ...
      schoolId: null,
      nextSlotId: "E2",
      feedingSlotIds: ["LEAF_FF2a", "LEAF_FF2b"],
    },
    // Elite 8 game slots
    {
      id: "E1",
...
export const defaultSettings: CompetitionSettings = {
  ...
  seeding_bonus_points: {
    ...
    elite_8: 16,
    final_four: 32,
    championship_runner_up: 64,
    championship_winner: 128,
  },
};
